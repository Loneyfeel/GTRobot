...
const DelayedModal = ({iconButtonRect}) => {
    ...
    return (
        <>
            <SharedBackdrop open={openScreenerBtn || openSortBtn || openFiltersBtn || openResetBtn} onClose={() => {}} />
            <ModalScreenerBtn open={openScreenerBtn} handleClose={handleCloseScreenerHint} iconButtonRect={iconButtonRect}/>
            <ModalSortBtn open={openSortBtn} handleClose={handleCloseSortHint} iconButtonRect={iconButtonRect}/>
            <ModalFiltersBtn open={openFiltersBtn} handleClose={handleCloseFiltersHint} iconButtonRect={iconButtonRect}/>
            <ModalResetBtn open={openResetBtn} handleClose={handleCloseResetHint} iconButtonRect={iconButtonRect}/>
        </>
    )
}
