                ...
                {isDailyMiningActive ? (
                    ...
                    <>
                        <HalfCircleProgressBar
                            value={userSubscription === 'ultra' ? Math.min(userGTRobotMiningBalance, 300) : userSubscription === 'pro' ? Math.min(userGTRobotMiningBalance, 200) : Math.min(userGTRobotMiningBalance, 100)}
                            max={userSubscription === 'ultra' ? 300 : userSubscription === 'pro' ? 200 : 100}
                            width={'300px'}
                            height={'100px'}
