...
const Withdraw = ({ setIsSectionOpen }) => {
  ...
  const [isAmountErrorSnackbarOpen, setAmountErrorSnackbarOpen] =
    useState(false);
  const [isEmptyFieldsErrorSnackbarOpen, setEmptyFieldsErrorSnackbarOpen] =
    useState(false);
  const [isWithdrawError404SnackbarOpen, setIsWithdrawError404SnackbarOpen] =
    useState(false);
  const [isWithdrawError2010SnackbarOpen, setIsWithdrawError2010SnackbarOpen] =
    useState(false);
  const [isWithdrawError2011SnackbarOpen, setIsWithdrawError2011SnackbarOpen] =
    useState(false);
  const [isWithdrawError2012SnackbarOpen, setIsWithdrawError2012SnackbarOpen] =
    useState(false);
  const [isWithdrawError2013SnackbarOpen, setIsWithdrawError2013SnackbarOpen] =
    useState(false);
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Typography>{t("mining.pages.menu.withdraw.send")}</Typography>
            </Box>
            <Box
              sx={{
                display: "flex",
          ...
          >
            ...
            >
              <Typography>{t("mining.pages.menu.withdraw.receive")}</Typography>
            </Box>
            <Box
              sx={{
                display: "flex",
        ...
        >
          <Alert severity="error" sx={{ width: "100%" }}>
            {t("mining.pages.menu.withdraw.snackbars.error2010")}
          </Alert>
        </Snackbar>
        <Snackbar
        ...
        >
          <Alert severity="error" sx={{ width: "100%" }}>
            {t("mining.pages.menu.withdraw.snackbars.error2011")}
          </Alert>
        </Snackbar>
        <Snackbar
        ...
        >
          <Alert severity="error" sx={{ width: "100%" }}>
            {t("mining.pages.menu.withdraw.snackbars.error2012")}
          </Alert>
        </Snackbar>
        <Snackbar
        ...
        >
          <Alert severity="error" sx={{ width: "100%" }}>
            {t("mining.pages.menu.withdraw.snackbars.error2013")}
          </Alert>
        </Snackbar>
      </Box>
    </>
