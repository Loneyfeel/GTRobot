  ...
  const questions = [
    {
      ...
      answers: [
        `${t("mining.components.helps.survey.yes")}`,
        `${t("mining.components.helps.survey.no")}`,
      ],
            ...
            <>
              ...
              >
                <CustomCheckbox
                  ...
                  checked={
                    selectedAnswer === questions[currentQuestion].answers[0]
                  }
                ...
                <CustomCheckbox
                  ...
                  checked={
                    selectedAnswer === questions[currentQuestion].answers[1]
                  }
                  onChange={handleAnswer}
                />
              </Box>
