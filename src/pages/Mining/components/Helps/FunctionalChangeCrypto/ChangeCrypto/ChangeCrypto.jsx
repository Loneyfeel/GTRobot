  ...
  const coinData = [
    {
      crypto: "btc",
      icon: bitcoinIcon,
      text: `${t("mining.pages.menu.coins.text_btc")}`,
    },
    {
      crypto: "doge",
      icon: dogeIcon,
      text: `${t("mining.pages.menu.coins.text_doge")}`,
    },
    {
      crypto: "ton",
      icon: tonIcon,
      text: `${t("mining.pages.menu.coins.text_ton")}`,
    },
    {
      crypto: "shib",
      icon: shibaIcon,
      text: `${t("mining.pages.menu.coins.text_shib")}`,
    },
  ];
        ...
        >
          ...
          >
            <Button
              ...
              sx={{
                backgroundColor: buttonState.selected
                  ? "#269926"
