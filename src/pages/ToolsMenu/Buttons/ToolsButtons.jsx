...
const AnalyticsOutlinedIcon = lazy(
    ...
    <>
      ...
      >
        <ToolsButton
          id="Analysis"
          icon={<SearchIcon />}
          text={t("toolsMenu.buttons.analysis")}
          url={appendLocaleToUrl("/signals")}
        />
        <ToolsButton
          id="Monitoring"
          icon={<AnalyticsOutlinedIcon />}
          text={t("toolsMenu.buttons.monitoring")}
          url={appendLocaleToUrl("/klines")}
        />
        <ToolsButton
          id="Forex"
          icon={<AutoModeIcon />}
          text={t("toolsMenu.buttons.forex")}
          url={appendLocaleToUrl("/forex")}
        />
        <ToolsButton
          id="Mining"
          icon={<FilterDramaIcon />}
          text={t("toolsMenu.buttons.mining")}
          url={appendLocaleToUrl("/mining")}
        />
      </Box>
    </>
  );
